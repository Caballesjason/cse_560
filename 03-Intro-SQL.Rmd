...
## Null
Its possible for a component in a tuple to not have a value.  DBMS' use the keyword `NULL` to indicate that there is a value does not exist for a component.  Any arithmetic operation that deals with a component with `NULL` returns `NULL`.
